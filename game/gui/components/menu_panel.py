...
class MenuPanel:
    def __init__(self):
        self.visible = True
        self.components = []
        # self.text = '> PRESS SPACEBAR TO START GAME <'
        self.x = 0
        self.y = 0
    ...
    def update(self):
        if self.visible:
            ScoreManager.menuWindowIsActive = True
    ...
    def draw(self):
        if self.visible:
            ...
            for component in self.components:
                ...
                component.draw()
            #arcade.draw_text(self.text, viewport_left + 200, viewport_bottom + 100, arcade.csscolor.WHITE_SMOKE, 25)