...
from game.gui.menu_components.scrolling_buttons import UpButton, DownButton
...
class MenuGui:
    def __init__(self):
        ...
        self.levels_panel.add_component(UpButton(self.levels_panel, SCREEN_WIDTH/2 - 30, 600))
        self.levels_panel.add_component(DownButton(self.levels_panel, SCREEN_WIDTH / 2 + 30, 600))
